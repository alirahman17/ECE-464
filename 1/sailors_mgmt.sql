...
insert into boats values (101,'Interlake','blue', 45, 12);
insert into boats values (102,'Interlake','red', 45, 18);
insert into boats values (103,'Clipper','green', 40, 25);
insert into boats values (104,'Clipper','red', 40, 33);
insert into boats values (105,'Marine','red', 35, 27);
insert into boats values (106,'Marine','green', 35, 18);
insert into boats values (107,'Marine','blue', 35, 19);
insert into boats values (108,'Driftwood','red', 35, 20);
insert into boats values (109,'Driftwood','blue', 35, 14);
insert into boats values (110,'Klapser','red', 30, 16);
insert into boats values (111,'Sooney','green', 28, 15);
insert into boats values (112,'Sooney','red', 28, 13);
...
insert into employees values (1,'Michael',5);
insert into employees values (2,'Peter',8);
insert into employees values (3,'Kevin',9);
insert into employees values (4,'Ali',10);
insert into hours values (1,'1998/9/8',8);
insert into hours values (1,'1998/9/15',7);
insert into hours values (2,'1998/9/8',8);
insert into hours values (2,'1998/9/15',9);
insert into hours values (2,'1998/9/22',10);
insert into hours values (3,'1998/9/8',8);
insert into hours values (3,'1998/9/15',12);
insert into hours values (4,'1998/9/22',8);
insert into hours values (4,'1998/9/29',6);
insert into hours values (4,'1998/10/6',12);
